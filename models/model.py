...
class Model(BaseModel):
    ...
    id: Annotated[
        Optional[str],
        Field(default=None, description="Unique identifier for the model"),
    ] = None
    """Unique identifier for the model"""
    name: Annotated[str, Field(..., description="Display name of the model")]
    """Display name of the model"""
    model: Annotated[
        str, Field(..., description="Identifier used to reference the model")
    ]
    ...
    task: Annotated[
        ...
        Field(
            ...,
            description='Type of task the model is designed for (e.g., "TextToText", "TextToImage")',
        ),
    ]
    """Type of task the model is designed for (e.g., \"TextToText\", \"TextToImage\")"""
    modified_at: Annotated[
        str, Field(..., description="Timestamp of when the model was last modified")
    ]
    """Timestamp of when the model was last modified"""
    digest: Annotated[
        str, Field(..., description="Hash digest identifying the model version")
    ]
    """Hash digest identifying the model version"""
    details: Annotated[
        ModelDetails, Field(..., description="Additional information about the model")
    ]
    ...
    pipeline: Annotated[
        ...
        Field(
            default=None,
            description='Pipeline type used for the model (e.g., "sd3", "sdxl")',
        ),
    ] = None
    """Pipeline type used for the model (e.g., \"sd3\", \"sdxl\")"""
    lora_weights: Annotated[
        Optional[List[LoraWeight]],
        Field(
            default=None, description="List of LoRA weights associated with the model"
        ),
    ] = None
    ...
    provider: Annotated[
        ...
        Field(
            ...,
            description='Provider or runtime of the model (e.g., "llama.cpp", "hf", "openai")',
        ),
    ]
    """Provider or runtime of the model (e.g., \"llama.cpp\", \"hf\", \"openai\")"""
    system_prompt: Annotated[
        Optional[str],
        Field(default=None, description="System prompt to use when running this model"),
    ] = None
    """System prompt to use when running this model"""
    parameters: Annotated[
        Optional[ModelParameters],
        Field(default=None, description="Default inference parameters for this model"),
    ] = None
    """Default inference parameters for this model"""
    image_settings: Annotated[
        Optional[ModelProfileImageSettings],
        Field(default=None, description="Image generation settings (for image models)"),
    ] = None
